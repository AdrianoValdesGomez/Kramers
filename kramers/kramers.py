...
def nombre(s):
    """This funtion returns a string of length 8 in which s (the imput) is a number and it has the necessary
    zeros to the left in order of being of 8 digit length"""
    diferencia = 8 - len(str(s))
    ceros = '' 
